  ...
  template: `
    <div class="p-6 space-y-4">
      ...
      <div class="max-w-md mb-6">
        <app-multi-select [(ngModel)]="selectedLanguages" placeholder="Select languages" label="Programming Languages">
          <app-select-item *ngFor="let lang of languages" [key]="lang.key">
            {{ lang.label }}
          </app-select-item>
        </app-multi-select>
      ...
      <div class="max-w-md mb-6">
        <app-multi-select [(ngModel)]="selectedTechs" placeholder="Select technologies" label="Tech Stack">
          <app-select-section *ngFor="let category of categories" [title]="category.title">
            <app-select-item *ngFor="let item of category.items" [key]="item.key">
              {{ item.label }}
            </app-select-item>
          </app-select-section>
        </app-multi-select>
